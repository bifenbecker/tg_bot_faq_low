...
class OrmInternalService(BaseImportService):
    ...
    def get_models_metadata(cls):
        ...
        metadata = cls.get_items(
            target_subfolders=cls.TARGET_SUBFOLDERS, not_checked_message=cls.METADATA_NOT_CHECKED_MESSAGE
        )
    ...
    def get_models(cls):
        ...
        models = cls.get_items(
            target_subfolders=cls.TARGET_SUBFOLDERS, not_checked_message=cls.MODELS_NOT_CHECKED_MESSAGE
        )
